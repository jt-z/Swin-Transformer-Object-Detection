...
if __name__ == "__main__":
    # imageidFile = ''
    mode_list =['val','train','test-dev','test-challenge']
    mode = 'val'
    assert mode in mode_list

    json_path = f'/home/stu010/datasets/VisDrone/VisDrone2019_DET_COCO/VisDrone2019-DET_{mode}_coco.json'
    image_path = f'/home/stu010/datasets/VisDrone/VisDrone2019_DET/VisDrone2019-DET-{mode}/images/'
    outpath = f'/home/stu010/datasets/VisDrone/VisDrone2019_DET_COCO/VisDrone2019-DET-{mode}/images/'
